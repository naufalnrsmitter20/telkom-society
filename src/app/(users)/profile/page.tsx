        ...
        <div className="bg-slate-100 p-0 sm:p-5 md:p-10 lg:p-15 xl:p-20">
            <div className='mt-24 bg-white rounded-3xl p-10 sm:p-10 md:p-15 lg:p-20 xl:p-24 relative overflow-hidden'>
                ...
                <div className="relative z-10 flex flex-col items-start mt-44 sm:mt-48 md:mt-44 lg:mt-32 xl:mt-28">
                    <div className="w-32 h-32 sm:w-24 md:w-32 lg:w-36 xl:w-40 sm:h-24 md:h-32 lg:h-36 xl:h-40 rounded-full bg-gray-300 mb-4"></div>
                    <div className='h-4'></div>
                    <h1 className="text-2xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-4xl font-normal">Haza Nasrullah Kuswantoro (Hacker)</h1>
                    ...
                    <p className="text-left text-gray-600 text-lg sm:text-lg md:text-xl lg:text-2xl xl:text-2xl mt-4">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem mollis aliquam ut porttitor leo a diam sollicitudin tempor. Lobortis scelerisque fermentum dui faucibus in ornare.
                    </p>
                </div>
                ...
                <div className="relative z-10 flex flex-col items-start my-8 mt-8">
                    ...
                    <ul className="space-y-2">
                        <li><a href="#" className="text-sm sm:text-sm md:text-lg lg:text-xl xl:text-xl text-blue-500">NexaLab</a></li>
                        <li><a href="#" className="text-sm sm:text-sm md:text-lg lg:text-xl xl:text-xl text-blue-500">AgroSky</a></li>
                        <li><a href="#" className="text-sm sm:text-sm md:text-lg lg:text-xl xl:text-xl text-blue-500">AgroSky</a></li>
                        <li><a href="#" className="text-sm sm:text-sm md:text-lg lg:text-xl xl:text-xl text-blue-500">LansiCare</a></li>
                        <li><a href="#" className="text-sm sm:text-sm md:text-lg lg:text-xl xl:text-xl text-blue-500">TrashEase</a></li>
                        <li><a href="#" className="text-sm sm:text-sm md:text-lg lg:text-xl xl:text-xl text-blue-500">SmartAca</a></li>
                    </ul>
                </div>
                ...
                <div className="relative z-10 flex justify-between items-start">
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><a href="#" className="text-sm sm:text-sm md:text-lg lg:text-xl xl:text-xl text-blue-500">Naufal Nabil Ramadhan - Hacker</a></li>
                            <li><a href="#" className="text-sm sm:text-sm md:text-lg lg:text-xl xl:text-xl text-blue-500">Haza - Hacker</a></li>
                            <li><a href="#" className="text-sm sm:text-sm md:text-lg lg:text-xl xl:text-xl text-blue-500">Fahrell - Hacker</a></li>
                            <li><a href="#" className="text-sm sm:text-sm md:text-lg lg:text-xl xl:text-xl text-blue-500">Dviki - Hustler</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><a href="#" className="text-sm sm:text-sm md:text-lg lg:text-xl xl:text-xl text-blue-500">LinkedIn: username</a></li>
                            <li><a href="#" className="text-sm sm:text-sm md:text-lg lg:text-xl xl:text-xl text-blue-500">GitHub: username</a></li>
                            <li><a href="#" className="text-sm sm:text-sm md:text-lg lg:text-xl xl:text-xl text-blue-500">WhatsApp: number</a></li>
                            <li><a href="#" className="text-sm sm:text-sm md:text-lg lg:text-xl xl:text-xl text-blue-500">Instagram: username</a></li>
                        </ul>
                    </div>
                </div>
            </div>
