        ...
        <main className="mt-20 lg:mt-32 mb-20">
            <div className="max-w-5xl mx-auto bg-white shadow-md lg:rounded-[20px] overflow-hidden">
                <div className="md:flex">
                    ...
                    <div className="p-8">
                        <div className="uppercase tracking-wide font-semibold text-4xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-black">
                            Grounded
                        </div>
                        ...
                        <div className="flex justify-between mt-4">
                            <div>
                                <p className="mt-2 text-gray-500 text-sm sm:text-sm md:text-sm lg:text-[16px] xl:text-[16px]">
                                    Mentor: Sir Bagus
                                </p>
                                <p className="mt-2 text-gray-500 text-sm sm:text-sm md:text-sm lg:text-[16px] xl:text-[16px]">
                                    ID: 123112313123
                            ...
                            <table className="table-auto w-full mt-7">
                                <tbody>
                                    <tr className="flex justify-between items-center">
                                        <td className="w-2/3">
                                            <p className={clsx("text-sm sm:text-sm md:text-sm lg:text-[16px] xl:text-[16px] text-black md:text-black lg:text-black")}>
                                                Naufal Nabil Ramadhan (Leader) (Hacker)
                                            </p>
                                        </td>
                                    ...
                                    <tr className="flex justify-between items-center">
                                        <td className="w-2/3">
                                            <p className="text-sm sm:text-sm md:text-sm lg:text-[16px] xl:text-[16px] text-black md:text-black lg:text-black">
                                                Ryo Hariyono Angwyn (Hipster)
                                            </p>
                                        </td>
                                        <td className="flex justify-end space-x-4 w-1/3">
                                            <button className="bg-red-500 scale-75 sm:scale-75 lg:scale-100 text-white py-1 px-2 rounded-lg hover:bg-red-600 transition duration-300">View</button>
                        ...
                        <div className="mt-8 flex space-x-4">
                            <a href="https://www.linkedin.com" className="text-blue-500 hover:underline">LinkedIn</a>
                            <a href="https://www.instagram.com" className="text-blue-500 hover:underline">Instagram</a>
                            <a href="https://www.github.com" className="text-blue-500 hover:underline">Github</a>
                            <a href="https://www.youtube.com" className="text-blue-500 hover:underline">Youtube</a>
                        </div>
                    </div>
                </div>
            </div>
