...
export default function Home({ users, teams }: { users: userOnlyPayloadMany; teams: teamPayloadMany }) {
  ...
  return (
    <main className="mt-[200px]">
      ...
      <div className="w-full max-w-full h-[1100px] xl:h-full xl:min-h-screen relative mt-[100px] xl:mt-[200px] xl:bg-transparent bg-red-500">
        ...
        <div className="flex flex-col justify-center text-center w-full mb-10">
          <h1 className="xl:text-[36px] lg:text-[34px] md:text-[32px] sm:text-[30px] text-[28px] text-white font-[600] xl:mt-10 px-4">
