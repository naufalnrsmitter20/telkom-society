...
export default function PilihKeahlian() {
  const occupation: occupationProops[] = [
    { occupation: "Hipster (Product Innovation & Design)", value: "Hipster (Product Innovation & Design)", id: 1 },
    { occupation: "Hacker (Software and Technology)", value: "Hacker (Software and Technology)", id: 2 },
    { occupation: "Hustler (Product Presenter and Finance)", value: "Hustler (Product Presenter and Finance)", id: 3 },
  ];
