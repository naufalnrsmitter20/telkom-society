...
export function LinkButton({
  ...
  if (baseButton) {
    return (
      <Link
        href={href}
        className={`focus:outline-none text-white bg-base hover:bg-red-500 focus:ring-4 focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ${className} flex w-fit items-center duration-500`}
      >
        {withArrow && (
          <svg
            width="12"
    ...
    return (
      <Link
        href={href}
        className={`focus:outline-none text-black bg-white hover:bg-slate-100 focus:ring focus:ring-slate-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ${className} duration-500 `}
      >
        {children}
      </Link>
    );
    ...
    return (
      <Link
        href={href}
        className={`focus:outline-none text-black bg-slate-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ${className} duration-500 `}
      >
        {children}
      </Link>
    );
